...
## Video Processing
Run the code in `make_data` one by one to obtain the training images for individual identification. The trained model of detection can be found 'Sub-levels/3Weights/trained_model/resnet50_trained_144.h5' from [download](https://data.bris.ac.uk/data/dataset). Alternatively, you can [download](https://data.bris.ac.uk/data/dataset) this data from the folders 'Sub-levels/2Identification'. 
