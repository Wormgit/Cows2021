...
def parse_args(args):
    ...
    group.add_argument('--imagenet_weights',  help='Initialize the model with pretrained imagenet weights.', action='store_const', const=True, default=False)
    group.add_argument('--weights',           help='Initialize the model with weights from a file.',default = 'resnet50_cows_50.h5')
    ...
    parser.add_argument('--random_transform', help='image and annotations.', default=0,type=int)
